...
TCGplayer group `1419`: 3 products.

| TCGplayer ID | Product | Kind | Packs | Packs from | Pack mix | Mix confidence | Holds | Release | PPT price |
|---|---|---|---|---|---|---|---|---|---|
| 488312 | FireRed & LeafGreen Single Pack Blister | Blister | 1 | Description | 1 EX FireRed & LeafGreen | Exact | — | 2004 Q3 (set) | No |
| 98945 | FireRed & LeafGreen Booster Box | Booster box | 36 | Kind default | 36 EX FireRed & LeafGreen | Product set | — | 2004 Q3 (set) | No |
| 98946 | FireRed & LeafGreen Booster Pack | Booster pack | 1 | Kind default | 1 EX FireRed & LeafGreen | Product set | — | 2004 Q3 (set) | Yes |
<!-- product-catalog:end -->

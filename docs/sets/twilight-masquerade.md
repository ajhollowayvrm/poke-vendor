...
Set data for Twilight Masquerade. The shared pack template, pack order, and
...
- **English release:** May 24, 2024.
- **Set code:** TWM.
- **Card count:** 226 cards. The main set has 167 cards. The secret rares are
  59 cards, numbered 168/167 to 226/167.

| Part | Rarity | Cards |
|---|---|---|
| Main set | Common | 76 |
| Main set | Uncommon | 55 |
| Main set | Rare | 16 |
| Main set | Double Rare | 14 |
| Main set | ACE SPEC Rare | 6 |
| Secret rares | Ultra Rare | 21 |
| Secret rares | Illustration Rare | 21 |
| Secret rares | Special Illustration Rare | 11 |
...
**Confidence:** TCGplayer's opened-pack study places the ACE SPEC Rare in "the
first Reverse Holo slot". Bulbapedia's table agrees. The Basic Energy and code
card come from era-wide sources only.

**Exception:** reverse holo slot 1 can hold an ACE SPEC Rare, the same as in
Temporal Forces.
...
|---|---|---|---|---|---|
| Rare | Rare slot | 16 | 76.46% | Unknown | Derived from the empirical study (100% minus Double Rare and Ultra Rare) |
| Double Rare | Rare slot | 14 | 16.93% ± 0.79% (1 in 6) | 1.21% ± 0.23% (1 in 83) | Empirical study |
| Ultra Rare | Rare slot | 21 | 6.61% ± 0.52% (1 in 15) | 0.31% ± 0.12% (1 in 318) | Empirical study |
| Reverse Holo (in reverse holo slot 1) | Reverse holo slot 1 | — | 94.94% | — | Derived from the empirical study |
| ACE SPEC Rare | Reverse holo slot 1 | 6 | 5.06% ± 0.46% (1 in 20) | 0.84% ± 0.19% (1 in 119) | Empirical study |
| Reverse Holo (in reverse holo slot 2) | Reverse holo slot 2 | — | 90.42% | — | Derived from the empirical study |
| Illustration Rare | Reverse holo slot 2 | 21 | 7.73% ± 0.56% (1 in 13) | 0.37% ± 0.13% (1 in 272) | Empirical study |
| Special Illustration Rare | Reverse holo slot 2 | 11 | 1.17% ± 0.23% (1 in 86) | 0.11% ± 0.07% (1 in 941) | Empirical study |
| Hyper Rare | Reverse holo slot 2 | 6 | 0.68% ± 0.17% (1 in 146) | 0.11% ± 0.07% (1 in 879) | Empirical study |
| Shiny Rare | — | 0 | Not in this set | — | — |
| Shiny Ultra Rare | — | 0 | Not in this set | — | — |

Other figures:

- TCGplayer says the rarity rates "appear to be completely identical" to
  Temporal Forces. Empirical study.
- **Special Illustration Rare Greninja ex:** 0.11% per pack (TCGplayer).
  Empirical study.

## Special subsets and mechanics

- **ACE SPEC cards:** six ACE SPEC Trainer and Special Energy cards, for
  example Unfair Stamp and Legacy Energy (TCGplayer, Bulbapedia). They are
  part of the main set numbering (Bulbapedia set list).
- No shiny subset.
...
|---|---|
| Booster Display Box | 36. An 18-pack box was also sold in European markets. |
| Elite Trainer Box (Teal Mask Ogerpon promo) | 9 |
| Pokémon Center Elite Trainer Box | 11 |
| Booster Bundle | 6 |
| Build & Battle Box | 4 |
| Collector's Kit | 1 |
| Blisters (Checklane, Stage 1) | Unknown per blister |

Multi-set products with packs of this set. Bulbapedia calls these mixes
"typical", so the mix is variable:

- Palafin ex Box: 4 packs, usually 2 Twilight Masquerade.
- Lycanroc ex Box: 4 packs, usually 2 Twilight Masquerade.
- Collector Chest (Back-to-School 2024): 6 packs, usually 2 Twilight
  Masquerade.
- Dark Powers ex Special Collection: 5 packs, usually 2 Twilight Masquerade.
...
| Reverse holo slot 1 | 1 | ACE SPEC Rare | ACE SPEC Rare | ACE SPEC Rare | Holo | All | 5.06% |
| Reverse holo slot 1 | 1 | Reverse holo | Reverse holo | Common, Uncommon, Rare | Reverse holo | All | Rest |
| Reverse holo slot 2 | 1 | Illustration Rare | Illustration Rare | Illustration rare | Holo | All | 7.73% |
| Reverse holo slot 2 | 1 | Special Illustration Rare | Special Illustration Rare | Special illustration rare | Holo | All | 1.17% |
| Reverse holo slot 2 | 1 | Hyper Rare | Hyper Rare | Hyper rare | Holo (Gold) | All | 0.68% |
| Reverse holo slot 2 | 1 | Reverse holo | Reverse holo | Common, Uncommon, Rare | Reverse holo | All | Rest |
| Rare slot | 1 | Double Rare | Double Rare | Double rare | Holo | All | 16.93% |
...
| 4 | Rare | Rarity | 76.46% | Yes |
| 5 | Double Rare | Rarity | 16.93% | Yes |
| 6 | Illustration Rare | Rarity | 7.73% | Yes |
| 7 | Ultra Rare | Rarity | 6.61% | Yes |
| 8 | ACE SPEC Rare | Rarity | 5.06% | Yes |
| 9 | Special Illustration Rare | Rarity | 1.17% | Yes |
| 10 | Hyper Rare | Rarity | 0.68% | Yes |

## Sources

- [Bulbapedia — Twilight Masquerade (TCG)](https://bulbapedia.bulbagarden.net/wiki/Twilight_Masquerade_(TCG))
...
- **Slot map:** six Rare cards (Infernape, Froslass, Munkidori,
  Fezandipiti, Hisuian Arcanine, Okidogi) carry an extra plain Normal
  print, and two cards (Finizen, Palafin) carry an extra plain Holo
  print, with no promo or special tag. The era rule makes Rare cards
  holofoil, and Finizen and Palafin already have their own Normal and
  Reverse holo prints, so the slot map treats these extra prints as
  not from packs. They stay unused.
...
- **Rarity list order:** by this file's odds, Illustration Rare (7.73%) is more common than Ultra Rare (6.61%), even though Ultra Rare is the higher secret-rare tier by name.

...
Set-specific data for White Flare. This is one file per set. See
[../13-sets.md](../13-sets.md) for the general approach and the index.
The shared pack template, pack order, and rarity system are in
[eras/scarlet-violet.md](eras/scarlet-violet.md).

White Flare is one half of a split special expansion. The other half is
[Black Bolt](black-bolt.md). The two sets share release date, pack
template, and the only pull-rate study. **Read
[black-bolt.md](black-bolt.md) for the full pack order analysis and
the odds table.** This file records the White Flare differences and
repeats the data the rip screen needs.
...
| Set code | WHT | Not confirmed in a fetched source (Cardrake uses "rsv10pt5") |
| Japanese source set | White Flare (SV11W), June 6, 2025, 7 cards per Japanese pack | PokiPair |
| Main set | 86 cards | Bulbapedia, Cardrake |
| Secret rares | 87 cards | Cardrake |
| Total | 173 cards | Bulbapedia |

White Flare has one more secret rare than Black Bolt (173 against
172). The extra card is one more Illustration Rare (70 against 69).
...
|---|---|---|
| Common | 38 | Main set |
| Uncommon | 32 | Main set |
| Rare | 10 | Main set |
| Double Rare | 6 | Main set |
| Illustration Rare | 70 | Secret |
| Ultra Rare | 8 | Secret |
...
(pokemon.com, Elite Trainer Box). The slot contents are **unknown** for
this set. The expected layout copies the Prismatic Evolutions slot
report:

| Slot | Count | Expected contents |
|---|---|---|
| Common | 4 | Common |
| Uncommon | 3 | Uncommon |
| Reverse holo 1 | 1 | Regular reverse holo or Poké Ball pattern |
| Reverse holo 2 | 1 | Regular reverse holo, Master Ball pattern, Illustration Rare, Special Illustration Rare, or Black White Rare |
...
Confidence: **unknown** for this set. The layout is the same as
[black-bolt.md](black-bolt.md#pack-order).
...
All studies combine Black Bolt and White Flare. No source measures
White Flare alone. Use the same odds as Black Bolt.

| Rarity | Rate | Confidence |
|---|---|---|
| Poké Ball pattern | 30.56% (about 1 in 3) | Empirical study (TCGplayer, 700+ packs, combined sets) |
| Double Rare | 21.11% (about 1 in 5) | Empirical study (TCGplayer, 700+ packs, combined sets) |
| Illustration Rare | 16.39% (about 1 in 6) | Empirical study (TCGplayer, 700+ packs, combined sets) |
| Ultra Rare | 5.83% (about 1 in 17) | Empirical study (TCGplayer, 700+ packs, combined sets) |
| Master Ball pattern | 5.14% (about 1 in 19); PokeBeach gives 1 in 15 | Empirical study; conflict |
| Special Illustration Rare | 1.25% (about 1 in 80); PokeBeach gives 1 in 76 | Empirical study |
| Black White Rare | 1 in 496 (0.2%) | Community estimate (PokéPatch, combined sets) |
| Hyper Rare, ACE SPEC Rare | Not in this set | — |

The full table with error margins and every source is in
[black-bolt.md](black-bolt.md#rarities-and-hit-odds).
...
See [black-bolt.md](black-bolt.md#sealed-products) for MSRP and
sources.

| Product | Packs |
|---|---|
| Elite Trainer Box | 9 |
| Pokémon Center Elite Trainer Box | Unknown |
| Booster Bundle | 6 |
| Binder Collection | 5 |
| Poster Collection, Mini Tin, Tech Sticker Collection, Victini Illustration Collection, Unova Heavy Hitters Premium Collection | Unknown |
...
TCGplayer group `24326`: 12 products.

| TCGplayer ID | Product | Kind | Packs | Packs from | Pack mix | Mix confidence | Holds | Release | PPT price |
|---|---|---|---|---|---|---|---|---|---|
| 630696 | White Flare Booster Bundle | Booster bundle | 6 | Description | 6 White Flare | Exact | — | 2025 Q3 | Yes |
| 630699 | White Flare Booster Pack | Booster pack | 1 | Kind default | 1 White Flare | Product set | — | 2025 Q3 | Yes |
| 630694 | White Flare  Binder Collection Case | Case or display | — | — | — | — | Unknown number of collections | 2025 Q3 | Yes |
| 630697 | White Flare Booster Bundle Case | Case or display | — | — | — | — | 25 booster bundles | 2025 Q3 | Yes |
| 630698 | White Flare Booster Bundle Display | Case or display | — | — | — | — | 10 booster bundles | 2025 Q3 | Yes |
...
| 685927 | White Flare Binder & Unova Poster Collection (Sam's Club) | Collection | 9 | Description | 2 Black Bolt, 2 White Flare | Partial | — | 2025 Q3 (set) | Yes |
| 630695 | White Flare Binder Collection | Collection | 5 | Bulbapedia | 5 White Flare | Exact | — | 2025 Q3 | Yes |
| 630700 | White Flare Tech Sticker Collection | Collection | 3 | Description | 3 White Flare | Exact | — | 2025 Q3 | Yes |
| 630689 | White Flare Elite Trainer Box | Elite Trainer Box | 9 | Description | 9 White Flare | Exact | — | 2025 Q3 | Yes |
| 630688 | White Flare Pokemon Center Elite Trainer Box (Exclusive) | Elite Trainer Box | 11 | Description | 11 White Flare | Exact | — | 2025 Q3 | Yes |
<!-- product-catalog:end -->
...
Confidence: this map follows the pack structure above, copied from the Prismatic Evolutions slot report (see black-bolt.md). The slot contents are Expected, not confirmed. Odds come from the TCGplayer study, which combines Black Bolt and White Flare.
...
- [Bulbapedia — White Flare (TCG)](https://bulbapedia.bulbagarden.net/wiki/White_Flare_(TCG))
- [Cardrake — White Flare master set](https://www.cardrake.com/expansions/rsv10pt5)
...
- [TCGplayer — Pokémon TCG: Black Bolt and White Flare Pull Rates](https://www.tcgplayer.com/content/article/Pok%C3%A9mon-TCG-Black-Bolt-and-White-Flare-Pull-Rates/bac92199-a2a7-4668-b4a4-2647a111776f/) (needs JavaScript)
...
- **Slot structure and pack order:** no source for this set.

...
Set-specific data for EX Hidden Legends, the fifth set of the EX
...
EX Hidden Legends has no Rare Holo ☆. Rare Holo ☆ starts with the next
set, EX Team Rocket Returns (see
...
| Field | Value | Source |
|---|---|---|
| English release date | June 14, 2004 | Bulbapedia |
| Japanese source set | Undone Seal, January 16, 2004 | Bulbapedia |
| Set number | #20 (English), #21 (Japanese) | Bulbapedia |
| Set code | Not confirmed in a fetched source | — |
| Total | 102 cards (English), 83 cards (Japanese) | Bulbapedia |
...
this for EX Hidden Legends specifically. A Secret Rare, when pulled,
occupies the rare slot in place of a Rare, Rare Holo, or Rare Holo ex.
...
| Rare Holo | 9 | 1 in 4 | Community estimate |
| Rare Holo ex | 3 | 1 in 12 | Community estimate |
| Secret Rare | Unknown | Unknown | Unknown |

The Rare, Rare Holo, and Rare Holo ex counts (24 + 9 + 3 = 36) add up
to exactly one card per pack across the 36-pack box, matching a single
rare slot. The thread gives no separate Secret Rare box count for this
set. See Open topics.
...
- **Regi trio.** Bulbapedia: Regirock ex, Regice ex, and Registeel ex
  appear as Rare Holo ex cards.
- **Two Theme Decks:** Forest Guardian (Colorless/Grass) and Wish Maker
  (Psychic/Water) (Bulbapedia).
- **Reverse Holofoil redesign.** Bulbapedia: Reverse Holofoil cards in
  this set carry a redesigned foil rarity symbol.
...
| Theme Deck | 0 (fixed 60-card deck) | Forest Guardian and Wish Maker versions (Bulbapedia). |
| EX Trainer Kit (June 2004) | 1 | Half-deck starter format, plus a Latios or Latias promo (era template). Release month matches this set's release. |
...
keeps the rarity order Rare > Rare Holo > Rare Holo ex, matching the
era rarity system's usual order. This set has no Rare Holo ☆.
...
| 5 | Rare Holo | Rarity | 1 in 4 | Yes |
| 6 | Rare Holo ex | Rarity | 1 in 12 | Yes |
| 7 | Secret Rare | Rarity | Unknown | Yes |

## Sources

- [Bulbapedia — EX Hidden Legends (TCG)](https://bulbapedia.bulbagarden.net/wiki/EX_Hidden_Legends_(TCG))
...
- **Secret Rare pack odds:** the Elite Fourum thread gives no per-box
  count for the Groudon Secret Rare. Searched 2026-09-12: no source
  found.

...
Set data for Celestial Storm. The era template is in
[eras/sun-moon.md](eras/sun-moon.md). See [../13-sets.md](../13-sets.md)
for the general approach.

## Release

- English release date: August 3, 2018.
- Abbreviation: CES. English set number: 77.
- Card count: 168 main set + 15 secret rares = 183.
- Source: Bulbapedia.
...
| Rare Holo | 1 in 6.2 | Empirical study |
| Rare Holo GX | 1 in 9 | Empirical study |
| Rare Prism Star (reverse slot) | 1 in 18 | Empirical study |
| Ultra Rare (full art Pokémon-GX + full art Trainer) | 1 in 24.5 | Empirical study |
| Rainbow Rare | 1 in 82.4 | Empirical study |
| Secret Rare (gold) | 1 in 123.6 | Empirical study |
| Reverse Rare Holo (reverse slot) | 1 in 8.1 | Estimate |
| Reverse Rare (reverse slot) | 1 in 8.5 | Estimate |

Odds source: ThePriceDex, which cites the Elite Fourum post for this
set.

Elite Fourum box ratios (per 36 packs): 4 "regular" Pokémon-GX, 0.8
full art Pokémon-GX, 1.4 full art Trainers and secret rares, 2 Prism
Stars. On the shared sheet, 8 secret rares print 3 times, 7 print 4
times, and the 8 full art Trainers print 6 times each. That gives 0.73
secret rares per box.

## Special subsets or mechanics

- Sceptile and Swampert (theme deck exclusive holos) are short printed.
- Three uncommons (Rainbow Energy, Rare Candy, Shrine of Punishment)
  are rarer than all non-holo rares, by the study's rebuilt uncommon
  sheet. Confidence: empirical study.
- Uncommons come from two sheets in turn: two runs of 54 uncommons per
  box.
...
| Celestial Storm Elite Trainer Box | 8 | Variable |
| Celestial Storm Build & Battle Box | 4 | Variable |
| Celestial Storm Three Pack Blister | 2 Celestial Storm + 1 Guardians Rising | Fixed mix |
| Celestial Storm Single Pack Blister | 1 | — |
| Celestial Storm Two Pack Blister | 1 Celestial Storm + 1 BREAKthrough | Fixed mix |
| Figure Two Pack Blisters | 1 Celestial Storm + 1 Guardians Rising | Fixed mix |

Source: Bulbapedia merchandise page; ThePriceDex for box size.

## Card list

Every card in the set, with its variants. Source: the TCGdex API (set `sm7`), fetched 2026-09-12. The list has 183 cards.
...
| 10/168 | Sceptile | Pokémon (Grass) | Rare | Normal, Reverse holo |
...
| 18/168 | Illumise | Pokémon (Grass) | Uncommon | Normal, Reverse holo |
| 19/168 | Cacnea | Pokémon (Grass) | Common | Normal, Reverse holo |
| 20/168 | Cacturne | Pokémon (Grass) | Uncommon | Normal, Reverse holo |
| 21/168 | Tropius | Pokémon (Grass) | Uncommon | Normal, Reverse holo |
| 22/168 | Dhelmise | Pokémon (Grass) | Rare | Normal, Reverse holo |
| 23/168 | Slugma | Pokémon (Fire) | Common | Normal, Reverse holo |
| 24/168 | Magcargo | Pokémon (Fire) | Rare | Normal, Reverse holo |
...
| 42/168 | Huntail | Pokémon (Water) | Uncommon | Normal, Reverse holo |
...
| 52/168 | Manectric | Pokémon (Lightning) | Rare | Normal, Reverse holo |
...
| 74/168 | Larvitar | Pokémon (Fighting) | Common | Normal, Reverse holo |
| 75/168 | Pupitar | Pokémon (Fighting) | Uncommon | Normal, Reverse holo |
| 76/168 | Meditite | Pokémon (Fighting) | Common | Normal, Reverse holo |
| 77/168 | Medicham | Pokémon (Fighting) | Rare | Normal, Reverse holo |
...
| 125/168 | Beast Ball | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 126/168 | Bill’s Maintenance | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 127/168 | Copycat | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 128/168 | Energy Recycle System | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 129/168 | Energy Switch | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 130/168 | Fisherman | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 131/168 | Friend Ball | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 132/168 | Hau | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 133/168 | Hiker | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 134/168 | Hustle Belt | Trainer (Tool) | Uncommon | Normal, Reverse holo |
| 135/168 | Last Chance Potion | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 136/168 | Life Herb | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 137/168 | Lisia | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 138/168 | Lure Ball | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 139/168 | The Masked Royal | Trainer (Supporter) | Uncommon | Normal, Reverse holo |
| 140/168 | PokéNav | Trainer (Item) | Uncommon | Normal, Reverse holo |
| 141/168 | Rainbow Brush | Trainer (Item) | Uncommon | Normal, Reverse holo |
...
repeat, and Secret Rare is the trailing Trainer and Energy cards.
TCGdex tags Prism Star cards with the ◇ mark in the card name, inside
the Rare rarity; the map finds them by name and number, so the reverse
holo slot's Prism Star outcome and the rare slot's Rare Holo outcome do
not share cards.
...
| Reverse holo | 1 | Rare Prism Star | Rare Prism Star | Rare | Holo | Nos. 97,107,108 | 5.56% |
| Reverse holo | 1 | Reverse holo | Reverse holo | Common, Uncommon, Rare | Reverse holo | All | Rest |
| Rare slot | 1 | Secret Rare | Secret Rare | Secret Rare | Holo | Nos. 178–183 | 0.81% |
| Rare slot | 1 | Rainbow Rare | Rainbow Rare | Secret Rare | Holo | Nos. 169–177 | 1.21% |
| Rare slot | 1 | Ultra Rare | Ultra Rare | Ultra Rare | Holo | Nos. 152–168 | 4.08% |
| Rare slot | 1 | Rare Holo GX | Rare Holo GX | Ultra Rare | Holo | Nos. 14–109 | 11.11% |
| Rare slot | 1 | Rare Holo | Rare Holo | Rare | Holo | Not nos. 97,107,108 | 16.13% |
...
- [ThePriceDex — Celestial Storm Pull Rates](https://www.thepricedex.com/set/sm7/celestial-storm/pull-rates)
- [Elite Fourum — Rarity Guide, Celestial Storm (post 148)](https://www.elitefourum.com/t/the-english-pokemon-card-rarity-guide/39762/148)
...
- **Slot map:** TCGdex tags Prism Star cards with a ◇ mark in the card
  name, inside the Rare rarity. The map lists the 3 Prism Star cards by
  number, so Rare Prism Star and Rare Holo do not share cards.
- **Slot map:** the Ultra Rare Normal variant (28 cards) and the Secret

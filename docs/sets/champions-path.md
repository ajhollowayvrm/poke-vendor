...
Set data for Champion's Path, a special expansion. See
...
- English release: September 25, 2020.
- Set code: SWSH3.5 (official website and checklist). Code card sequence code:
  CP. Abbreviation: CPA. TCGplayer set code: CHP.
- Cards: 80 total. 73 in the main numbering, plus 7 secret rares.
...
- The set list has no plain Rare cards. Thus the rare slot is Rare Holo or
  higher (derived from the Bulbapedia set list).

## Pack order

**Confidence: community guide, low.** NinePocket lists Champion's Path under
the Sun & Moon to Sword & Shield method. No other source was found.
...
Card counts per Bulbapedia rarity label (80 cards):
...
- No English booster box. Packs came only in set products.
...
| Pin Collection (Turffield, Hulbury, Motostoke, Ballonlea, Spikemuth, Hammerlocke Gym) | 3 | Bulbapedia merchandise |
| Collection—Dubwool V | 4 | Bulbapedia merchandise |
| Collection—Hatterene V | 4 | Bulbapedia merchandise |
| Special Pin Collection—Stow-on-Side | 5 | Bulbapedia merchandise |
| Special Pin Collection—Circhester | 5 | Bulbapedia merchandise |
| Special Collection—Marnie (outside North America) | 5 | Bulbapedia merchandise |
| Premium Collection—Marnie | 8 | Bulbapedia merchandise |
...
- [TCGplayer — Champion's Path Booster Pack](https://www.tcgplayer.com/product/218789)

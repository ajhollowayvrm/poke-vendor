...
TCGplayer group `1376`: 3 products.

| TCGplayer ID | Product | Kind | Packs | Packs from | Holds | Release | PPT price |
|---|---|---|---|---|---|---|---|
| 98518 | EX Dragon Booster Box | Booster box | 36 | Kind default | — | 2003 Q4 (set) | No |
| 98519 | EX Dragon Booster Pack | Booster pack | 1 | Kind default | — | 2003 Q4 (set) | No |
| 488300 | Dragon Theme Deck - "FireFang" [Salamence] | Deck | 0 | Bulbapedia (no booster pack in contents) | — | 2003 Q4 (set) | No |
<!-- product-catalog:end -->

...
The first special set of the Mega Evolution era. It breaks the era
template in several ways. One file per set (see
[../13-sets.md](../13-sets.md)). The shared era template is in
[eras/mega-evolution.md](eras/mega-evolution.md).

## Release

- **English release**: 2026-01-30 (Bulbapedia, TCGplayer). The Elite
  Trainer Boxes came later, on 2026-02-20 (TCGplayer).
- **Set code**: ASC. Product line code: ME2.5, written "me2pt5" by
  ThePriceDex. TCGplayer uses "ME: Ascended Heroes".
- **Card count**: 217 main set + 78 secret rares = 295 cards. Bulbapedia
  calls it "the largest Pokémon TCG expansion" in English.
- **Rarity counts** (Cardrake): 84 Common, 69 Uncommon, 25 Rare,
  39 Double Rare, 14 Ultra Rare, 7 Mega Attack Rare, 33 Illustration
  Rare, 22 Special Illustration Rare, 2 Mega Hyper Rare. These add up
  to 295.
- The Japanese counterpart is MEGA Dream ex (CardCodex).
...
Friend Ball, Quick Ball, or Dusk Ball). Team Rocket's Pokémon get an "R"
pattern in place of the ball (PokeBeach set guide, search summary;
Cardrake).
...
Confidence: **Unknown for this set**. No source describes the Ascended
Heroes pack order. The table below is the era template. The two reverse
holo patterns may change positions 8 and 9.

| Position | Card |
|---|---|
| 1-4 | Common x4 |
| 5-7 | Uncommon x3 |
| 8 | Reverse holo (pattern Unknown) |
| 9 | Reverse holo (pattern Unknown), or an IR / SIR |
| 10 | Rare slot: Rare, Double Rare, Ultra Rare, Mega Attack Rare, or Mega Hyper Rare |
| 11 | Basic Energy |
| 12 | Code card |

- The rare-slot hit is position 10 of 12, one of the last three cards.
...
Main source: TCGplayer, from more than 2,000 opened packs, with god
packs excluded (PokeBeach summary, EternaCards, ThePriceDex).
...
| Double Rare | 1 in 5 | Empirical study (TCGplayer, 2,000+ packs) |
| Ultra Rare | 1 in 21 | Empirical study (TCGplayer) |
| Mega Attack Rare | 1 in 29 | Empirical study (TCGplayer) |
| Illustration Rare | 1 in 9 | Empirical study (TCGplayer) |
| Special Illustration Rare | 1 in 70 | Empirical study (TCGplayer) |
| Mega Hyper Rare | 1 in 540 | Empirical study (TCGplayer) |
| Energy reverse common / uncommon / rare | 1 in 2.3 / 1 in 2.8 / 1 in 7.6 | Community estimate (ThePriceDex) |
| Poké Ball reverse common / uncommon / rare | 1 in 2.0 / 1 in 3.6 / 1 in 6.0 | Community estimate (ThePriceDex) |

Conflicting community figures (TCG Talk, "community aggregate data"):
SIR 1 in 100-120, IR 1 in 18-25, full-art Pokémon 1 in 45-60, full-art
Trainer 1 in 25-35, Double Rare 1 in 5-7. These use a smaller sample and
different categories. Prefer the TCGplayer figures.

## Special subsets and mechanics

### Mega Attack Rare

A new rarity. Bulbapedia: "Full Art Mega Evolution Pokémon ex with
artworks rendered in a pop art style, and the card's highlight attack
written with large text." The set has 7.

### God packs

- A god pack holds only high-rarity cards and no commons or uncommons.
- **Contents conflict**:
  - CardCodex: every slot holds an Illustration Rare, a Special
    Illustration Rare, or a Mega Attack Rare "or higher".
  - A search-result snippet (source page not confirmed): 3 Mega Attack
    Rares and 7 Special Illustration Rares.
- **Odds conflict** (all community estimates, no official figure):
  - CardCodex: about 1 in 950 to 1 in 2,000 packs.
  - TCG Talk: 1 in 1,500 to 1 in 4,000 packs. This range comes from god
    packs "across multiple SV era sets", not from this set alone.
- **Pack weight**: TCG Talk reports one confirmed god pack at 23.80 g.
  Normal packs weigh 22.45 to 22.86 g. This is one sample.
- TCG Talk also says, in its Pitch Black guide, that "no official
  god-pack mechanic is known for English Mega Evolution sets." This
  conflicts with the Ascended Heroes reports.

### Other

- 13 Mega Evolution Pokémon ex, 6 Tera Pokémon ex, 20 other Pokémon ex
  (Bulbapedia).
- **No booster boxes.** This is a special set.
...
| Mini Tin (5 designs) | 2 | TCGplayer, Pokemon.com |
| Tech Sticker Collection (Charmander or Gastly) | 3 | TCGplayer, Pokemon.com |
| Collection (Larry or Erika) | 2 | TCGplayer |
| ex Box (Feraligatr, Meganium, or Emboar) | 4 | TCGplayer |
| First Partners Deluxe Pin Collection | 5 | TCGplayer |
| Premium Poster Collection | 10 | TCGplayer |
...
TCGplayer group `24541`: 40 products.

| TCGplayer ID | Product | Kind | Packs | Packs from | Pack mix | Mix confidence | Holds | Release | PPT price |
|---|---|---|---|---|---|---|---|---|---|
| 668541 | Ascended Heroes Booster Bundle | Booster bundle | 6 | Description | 6 Ascended Heroes | Exact | — | 2026 Q2 | Yes |
| 672434 | Ascended Heroes Booster Pack | Booster pack | 1 | Kind default | 1 Ascended Heroes | Product set | — | 2026 Q1 | Yes |
| 681339 | Ascended Heroes Booster Bundle Case | Case or display | — | — | — | — | 25 booster bundles | 2026 Q2 | Yes |
| 692362 | Ascended Heroes Booster Bundle Display | Case or display | — | — | — | — | 10 booster bundles | 2026 Q1 (set) | Yes |
| 679558 | Ascended Heroes Elite Trainer Box Case | Case or display | — | — | — | — | Unknown number of elite trainer boxes | 2026 Q1 (set) | Yes |
| 672392 | Ascended Heroes First Partners Deluxe Pin Collection Case | Case or display | — | — | — | — | Unknown number of collections | 2026 Q1 | Yes |
| 672737 | Ascended Heroes Mega ex Boxes Case | Case or display | — | — | — | — | Unknown | 2026 Q1 (set) | Yes |
| 679556 | Ascended Heroes Mini Tin Display | Case or display | — | — | — | — | 10 mini tins | 2026 Q1 | Yes |
| 689031 | Ascended Heroes Mini Tin Display Case | Case or display | — | — | — | — | 10 mini tins | 2026 Q1 (set) | Yes |
| 702501 | Ascended Heroes Tin Case | Case or display | — | — | — | — | 6 tins | 2026 Q3 | Yes |
| 685195 | Mega Evolution: Ascended Heroes Collection case | Case or display | — | — | — | — | Unknown number of collections | 2026 Q1 (set) | Yes |
| 681333 | Mega Evolution: Ascended Heroes Tech Sticker Collection Case | Case or display | — | — | — | — | Unknown number of collections | 2026 Q1 (set) | Yes |
| 685000 | Premium Poster Collection Case | Case or display | — | — | — | — | Unknown number of collections | 2026 Q1 (set) | Yes |
| 672391 | Ascended Heroes First Partners Deluxe Pin Collection | Collection | 5 | Description | 5 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 706959 | Ascended Heroes Focused Fighters Premium Collection (Sam's Club) | Collection | 14 | Description | 14 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 672734 | Ascended Heroes Mega Emboar ex Box | Collection | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 672735 | Ascended Heroes Mega Feraligatr ex Box | Collection | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 672733 | Ascended Heroes Mega Meganium ex Box | Collection | 4 | Description | — | Unknown | — | 2026 Q1 (set) | Yes |
| 692541 | Costco Ascended Heroes Mega ex Box Bundle | Collection | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 709095 | Mega Evolution: Ascended Heroes Collection - Erika (1-Tab) | Collection | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 666906 | Mega Evolution: Ascended Heroes Collection - Erika (3-Tab) | Collection | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 709097 | Mega Evolution: Ascended Heroes Collection - Larry (1-Tab) | Collection | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 666907 | Mega Evolution: Ascended Heroes Collection - Larry (3-Tab) | Collection | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 691923 | Mega Evolution: Ascended Heroes Collection [Set of 2] | Collection | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 666908 | Mega Evolution: Ascended Heroes Tech Sticker Collection - Charmander | Collection | 3 | Description | 3 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 666909 | Mega Evolution: Ascended Heroes Tech Sticker Collection - Gastly | Collection | 3 | Description | 3 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668537 | Premium Poster Collection: Mega Gardevoir | Collection | 10 | Description | 10 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668536 | Premium Poster Collection: Mega Lucario | Collection | 10 | Description | 10 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668496 | Ascended Heroes Elite Trainer Box | Elite Trainer Box | 9 | Description | 9 Ascended Heroes | Exact | — | 2026 Q1 (set) | Yes |
| 668497 | Ascended Heroes Pokemon Center Elite Trainer Box (Exclusive) | Elite Trainer Box | 11 | Description | 9 Ascended Heroes | Partial | — | 2026 Q1 (set) | Yes |
| 668535 | Ascended Heroes Mini Tin [Clefairy & Chikorita] | Tin | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668531 | Ascended Heroes Mini Tin [Pikachu & Tepig] | Tin | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668532 | Ascended Heroes Mini Tin [Riolu & Darumaka] | Tin | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668534 | Ascended Heroes Mini Tin [Togepi & Totodile] | Tin | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668533 | Ascended Heroes Mini Tin [Zorua & Cramorant] | Tin | 2 | Description | 2 Ascended Heroes | Exact | — | 2026 Q1 | Yes |
| 668530 | Ascended Heroes Mini Tins 5-Pack | Tin | 10 | Description | — | Unknown | — | 2026 Q1 | Yes |
| 702496 | Ascended Heroes Tin [Mega Emboar ex] | Tin | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q3 | Yes |
| 702497 | Ascended Heroes Tin [Mega Feraligatr ex] | Tin | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q3 | Yes |
| 702498 | Ascended Heroes Tin [Mega Meganium ex] | Tin | 4 | Description | 4 Ascended Heroes | Exact | — | 2026 Q3 | Yes |
| 702500 | Ascended Heroes Tin [Set of 3] | Tin | 12 | Description | 12 Ascended Heroes | Exact | — | 2026 Q3 | Yes |
<!-- product-catalog:end -->
...
**Two reverse holo slots:** each non-ex Pokémon has an Energy pattern
reverse holo and a Poké Ball, Love Ball, Friend Ball, Quick Ball, Dusk
Ball, or Team Rocket "R" pattern reverse holo. Reverse holo 1 always
holds the Energy pattern. Reverse holo 2 holds the second pattern,
unless the card is an Illustration Rare or Special Illustration Rare.

**Mega Attack Rare:** TCGdex records Mega Attack Rare cards under the
Ultra Rare rarity, together with the plain Ultra Rare cards. Nos.
265–271 are the 7 Mega Attack Rares. The Cards column splits the two
outcomes by number range.

Confidence: this map follows the pack structure above. The slot
contents are a community guide, not confirmed for this set.

| Slot | Count | Outcome | Rarity list entry | TCGdex rarity | Variant | Cards | Odds in slot |
|---|---|---|---|---|---|---|---|
| Common | 4 | Common | Common | Common | Normal | All | 100% |
| Uncommon | 3 | Uncommon | Uncommon | Uncommon | Normal | All | 100% |
| Reverse holo 1 | 1 | Energy pattern reverse holo | Energy pattern reverse holo | Common, Uncommon, Rare | Reverse holo (Energy) | All | 100% |
| Reverse holo 2 | 1 | Illustration Rare | Illustration Rare | Illustration rare | Holo | All | 11.11% |
| Reverse holo 2 | 1 | Special Illustration Rare | Special Illustration Rare | Special illustration rare | Holo | All | 1.43% |
| Reverse holo 2 | 1 | Poké Ball pattern reverse holo | Poké Ball pattern reverse holo | Common, Uncommon, Rare | Reverse holo (Poké Ball pattern) or Reverse holo (Loveball) or Reverse holo (Quickball) or Reverse holo (Duskball) or Reverse holo (Friendball) or Reverse holo (Team rocket) or Reverse holo | All | Rest |
| Rare slot | 1 | Double Rare | Double Rare | Double rare | Holo | All | 20% |
| Rare slot | 1 | Ultra Rare | Ultra Rare | Ultra Rare | Holo | Not nos. 265–271 | 4.76% |
| Rare slot | 1 | Mega Attack Rare | Mega Attack Rare | Ultra Rare | Holo | Nos. 265–271 | 3.45% |
| Rare slot | 1 | Mega Hyper Rare | Mega Hyper Rare | Mega Hyper Rare | Holo (Gold) or Holo | All | 0.19% |
...
- [TCGplayer — Ascended Heroes Quick Facts](https://seller.tcgplayer.com/blog/ascended-heroes-quick-facts)
- [PokeBeach — Ascended Heroes pull rates finally determined](https://www.pokebeach.com/2026/02/ascended-heroes-pull-rates-finally-determined-better-than-usual)
- [PokeBeach — Ascended Heroes set guide: god packs, reverse holos, product lineup](https://www.pokebeach.com/2026/01/ascended-heroes-set-guide-full-set-list-god-packs-reverse-holos-product-lineup-and-more)
- [PokeBeach — Ascended Heroes to feature multiple reverse holo styles](https://www.pokebeach.com/2026/01/ascended-heroes-to-feature-multiple-reverse-holo-styles)
- [EternaCards — Ascended Heroes pull rates after 2,000+ packs](https://eternacards.co.uk/blogs/trading-card-game-news/ascended-heroes-pull-rates-revealed-after-2-000-packs-opened)
- [ThePriceDex — Ascended Heroes pull rates](https://www.thepricedex.com/set/me2pt5/ascended-heroes/pull-rates)
- [TCG Talk — Ascended Heroes pull rates and god pack](https://tcgtalk.com/guides/ascended-heroes-pull-rates-god-pack)
- [TCG Talk — Pitch Black pull rates (god pack statement)](https://tcgtalk.com/guides/pitch-black-pull-rates)
- [CardCodex — What is a god pack](https://cardcodex.com/blog/what-is-a-god-pack-in-pokemon-tcg/)
...
- **Slot map:** the code card row assumes a code card exists, following
  the era template. This is not confirmed for this set.

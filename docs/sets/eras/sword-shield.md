...
|---|---|---|
| Rare VMAX | 3.81% | 16 |
| Ultra-Rare Rare (Pokémon V) | 12.46% | 16 |
| Rare Secret | 0.91% | 15 |
| Rare Rainbow | 1.27% | 14 |
| Rare Holo | 25.44% | 10 |
| Rare Ultra (full art and alternate art) | 3.92% | 8 |
| Rare Ultra (full art) | 3.80% | 6 |
| Rare VSTAR | 3.75% | 6 |
| Reverse holo | 82.60% | 6 |
| Rare Radiant | 4.88% | 5 |
| Trainer Gallery — V, VMAX, or Trainer | 3.63% | 4 |
| Trainer Gallery — non-V Pokémon | 8.29% | 3 |
| Amazing Rare | 5.73% | 2 |
| Rare | 63.80% | 2 |
| Trainer Gallery — gold-and-black VMAX | 0.88% | 2 |
| Classic Collection | 40.10% | 1 |
| Galarian Gallery — Pokémon V or Trainer | 12.00% | 1 |
| Galarian Gallery — gold VSTAR | 0.80% | 1 |
| Galarian Gallery — non-V Pokémon | 22.40% | 1 |
| Rare Rainbow (rainbow and alternate-art VMAX) | 1.14% | 1 |
| Rare Ultra (full art and alternate-art V) | 3.88% | 1 |
| Rare Ultra (textured Energy and full-art Trainers) | 2.85% | 1 |
| Shiny Vault — Rare Shiny | 22.73% | 1 |
| Shiny Vault — Rare Shiny GX | 8.96% | 1 |
| Trainer Gallery — non-V, VMAX, or Trainer | 12.50% | 1 |

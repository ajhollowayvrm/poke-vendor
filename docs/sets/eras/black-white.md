...
|---|---|---|
| Rare Secret | 1.39% | 10 |
| Rare Ultra (Full Art) | 2.78% | 9 |
| Rare Holo EX | 5.56% | 8 |
| Rare ACE (ACE SPEC) | 2.78% | 4 |
| Reverse holo | 97.22% | 4 |
| Radiant Collection — Full Art | 25.00% | 1 |
| Radiant Collection — Rare (Meloetta-EX) | 4.17% | 1 |
| Radiant Collection — Uncommon | 70.83% | 1 |

...
- [18-ripping.md](18-ripping.md) — the rip screen: tear the pack, the cards slide out, swipe or tap through them with the hit in the last three cards (set files record exceptions), pack-by-pack or Open all for boxes, running value vs. cost, and the summary.

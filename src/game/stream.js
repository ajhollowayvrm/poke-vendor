...
import { isHit, cardValue, rarityRank, fmtMoney, showcaseStreamMult } from './engine'
...
export function baseViewers(notoriety, fatigue = 1, followers = 0, shopHype = 0, showcaseN = 0) {

...
const m = (id, group, icon, name, desc, goal, noto, value) => ({ id, group, icon, name, desc, goal, noto, value })
...
export const MILESTONES = [
  ...
  m('packs-500',  'Ripping', '📦', 'Case Cracker',  'Open 500 packs',           500, 12, packsOpened),
  m('packs-2000', 'Ripping', '📦', 'Pack Demon',    'Open 2,000 packs',        2000, 30, packsOpened),
  // Hits
  m('hits-10',   'Hits', '🌟', 'First Hits',   'Pull 10 hits',    10,  3, hitsPulled),
  m('hits-100',  'Hits', '🌟', 'Hit Hunter',   'Pull 100 hits',  100,  8, hitsPulled),
  m('hits-500',  'Hits', '🌟', 'Hit Machine',  'Pull 500 hits',  500, 20, hitsPulled),
  // Chase — god packs + best single pull
  m('god-1',       'Chase', '🎉', 'Blessed',           'Hit a god pack',                 1, 15, godPacks),
  m('god-5',       'Chase', '🎉', 'God Among Rippers', 'Hit 5 god packs',                5, 40, godPacks),
  m('grail-500',   'Chase', '💎', 'Big Hit',           'Pull a card worth $500+',      500,  5, bestPullValue),
  m('grail-5000',  'Chase', '💎', 'Grail Chaser',      'Pull a card worth $5,000+',   5000, 20, bestPullValue),
  m('grail-50000', 'Chase', '💎', 'Museum Piece',      'Pull a card worth $50,000+', 50000, 60, bestPullValue),
  // Wealth
  m('worth-10k',  'Wealth', '💰', 'Getting Somewhere', 'Reach $10k net worth',     10000,  5, netWorth),
  m('worth-50k',  'Wealth', '💰', 'Comfortable',       'Reach $50k net worth',     50000, 12, netWorth),
  m('worth-250k', 'Wealth', '💰', 'Big Time',          'Reach $250k net worth',   250000, 30, netWorth),
  m('worth-1m',   'Wealth', '💰', 'Millionaire',       'Reach $1M net worth',    1000000, 75, netWorth),
  // Grading
  m('graded-5',   'Grading', '🔟', 'Slabbed',           'Grade 5 cards',    5,  3, gradesSubmitted),
  m('graded-25',  'Grading', '🔟', 'Regular Submitter', 'Grade 25 cards',  25,  8, gradesSubmitted),
  m('graded-100', 'Grading', '🔟', 'Grading Loyalty',   'Grade 100 cards', 100, 20, gradesSubmitted),
  // Circuit
  m('shows-1',  'Circuit', '🎪', 'On the Circuit',   'Attend your first show', 1,  3, showsAttended),
  m('shows-10', 'Circuit', '🎪', 'Show Regular',     'Attend 10 shows',       10, 10, showsAttended),
  m('shows-30', 'Circuit', '🎪', 'Circuit Veteran',  'Attend 30 shows',       30, 25, showsAttended),
  // Generosity
  m('generous-1',  'Generosity', '🎗️', 'Made Their Day', 'Give a card away free',       1,  5, generousActs),
  m('generous-10', 'Generosity', '🎗️', 'Good Samaritan', 'Make 10 peoples’ day',        10, 15, generousActs),
  m('generous-25', 'Generosity', '🎗️', 'Local Legend',   'Make 25 peoples’ day',        25, 35, generousActs),
  // Reputation
  m('noto-25',  'Reputation', '⭐', 'Known Name',    'Reach 25 notoriety',   25,  3, notoriety),
  m('noto-100', 'Reputation', '⭐', 'Big Reputation', 'Reach 100 notoriety', 100,  6, notoriety),
  m('noto-250', 'Reputation', '⭐', 'Household Name', 'Reach 250 notoriety',  250, 12, notoriety),
  // Collector
  m('sets-1',  'Collector', '🃏', 'Completionist',   'Complete a full set',  1,  8, setsCompleted),
  m('sets-5',  'Collector', '🃏', 'Set Collector',   'Complete 5 sets',      5, 20, setsCompleted),
  m('sets-15', 'Collector', '🃏', 'Master Collector', 'Complete 15 sets',   15, 50, setsCompleted),
  // Streaming
  m('stream-1',      'Streaming', '🔴', 'Live!',            'Run your first stream',        1,  4, streams),
  m('stream-10',     'Streaming', '🔴', 'Content Creator',  'Run 10 streams',              10, 15, streams),
  m('viewers-100',   'Streaming', '📺', 'Drawing a Crowd',  'Hit 100 peak viewers',       100,  8, peakViewers),
  m('viewers-1000',  'Streaming', '📺', 'Internet Famous',  'Hit 1,000 peak viewers',    1000, 30, peakViewers),
  // Wants
  m('wants-1',  'Wants', '📋', 'Matchmaker',   'Fill a collector want', 1,  4, wantsFilled),
  m('wants-10', 'Wants', '📋', 'Go-To Dealer', 'Fill 10 wants',        10, 12, wantsFilled),
  m('wants-50', 'Wants', '📋', 'Wish Granter', 'Fill 50 wants',        50, 30, wantsFilled),
]

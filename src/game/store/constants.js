...
export const UPGRADES = {
  ...
  accountant: { name: 'Accountant', cost: 1800, icon: '🧮', desc: 'A bookkeeper who does this for a living. They find the deductions you would never have claimed — mileage to every show, the home office, packing materials, the phone line — worth 8% off every quarterly tax bill. And a return filed by a professional draws HALF the audit attention of one you did yourself, which matters most if your counter runs on cash. Pays for itself in about two good quarters.' },

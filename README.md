...
3. **Collection** — split into **Raw** and **Graded** tabs; clean borderless art. Every card is valued at live market price. Click a card to move it three ways:
   ...
   - **List on your site** — set your own asking price (market or higher). It sells **over time**, faster the higher your notoriety, minus a ~5% marketplace fee. Push the price too high and it may sit unsold — **relist or pull** it from the collection's listings strip. Pays out on Next Day / when you return from a show.
